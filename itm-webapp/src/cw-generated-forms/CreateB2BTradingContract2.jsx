/**
 * CreateB2BTradingContract2 - Generated Form Component
 *
...
const EMBEDDED_VARIANT_DATA = [
  {
    ...
    "variantName": "Create B2B Trading Contract 2",
    "definitionId": "IWM",
    "data": [
      {
...
// ─── Main Component ──────────────────────────────────────────────────────────────
const CreateB2BTradingContract2 = forwardRef(({ variantData: externalVariantData, initialData, requestOptions, onSubmit, onReset, columns = 2, title, showHeader = true, showFooter = true, readOnly = false, view = 'both' }, ref) => {
...
CreateB2BTradingContract2.displayName = 'CreateB2BTradingContract2';
export default CreateB2BTradingContract2;
/**
 * CreateB2BTradingContract3 - Generated Form Component
 *
...
const EMBEDDED_VARIANT_DATA = [
  {
    "variantId": "8589bf745abe4c678cdcf89e1b5de157",
    "variantName": "Create B2B Trading Contract 3",
    "definitionId": "IWM",
    "data": [
      {
        "variantFieldId": "b2d72df2a0194ef6a35c206144a1144f",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "e5449690-f2db-45d3-ae13-37fb586a9c75",
        "columnName": "ITM_CTC_PURCH_CUR",
        "label": "Purchasing Currency",
        "description": "Purchasing Currency",
        "maxLength": "5",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_PURCH_CUR",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "aliasName": "ITM_CTC_PURCH_CUR",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "7b57cae8ab794dd68989c66e3db50061",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "e560822d-67ad-40a7-9fdb-f23b0a6ff1a3",
        "columnName": "ITM_CTC_SALES_CUR",
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_SALES_CUR",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "b6de0bc8b83a4d0b80347171465e806a",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "4a661142-994b-4e2c-a08b-bd6a19188808",
        "columnName": "ITM_CTC_SUP_ACC_NO",
        "label": "Supplier Account No",
        "description": "Supplier Account No",
        "maxLength": "15",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_SUP_ACC_NO",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_SUP_ACC_NO",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "dd0e3461e2d048b181d1bd0ccaf07994",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "1b777ede-1325-4fc7-b745-3b045012d36e",
        "columnName": "ITM_CTC_CUST_REF",
        "label": "Customer PO Ref No.",
        "description": "Customer PO Ref No.",
        "maxLength": "15",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_CUST_REF",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_CUST_REF",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "430bfd775640453cbcea9bbda4fcd79c",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "a949b348-8137-4515-9734-75d6ee1b7371",
        "columnName": "ITM_CTC_PURCH_INCO",
        "label": "Purchase Incoterms",
        "description": "Purchase Incoterms",
        "maxLength": "3",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_PURCH_INCO",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
          ...
          "isSearchParam": null,
          "lookupType": "VL",
          "lookupId": "99abda5d85a34876ad153577617926c5",
          "businessType": "C",
          "isDefaulted": false,
          "defaultValue": null,
          "defaultValueText": null,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_PURCH_INCO",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "b35ba543070448adb563e561f437d066",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "80fb4e65-4d49-4f69-8042-337a1a727937",
        "columnName": "ITM_CTC_PURCH_INCO_LOC",
        "label": "Purchase Incoterms Location",
        "description": "Purchase Incoterms Location",
        "maxLength": "15",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_PURCH_INCO_LOC",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_PURCH_INCO_LOC",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "fb5ca93be5b04a31a9603eeb2ce843d7",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "ba0ce59b-1d6c-42be-8c29-8644bdf61656",
        "columnName": "ITM_CTC_SALES_INCO",
        "label": "Sales Incoterms",
        "description": "Sales Incoterms",
        "maxLength": "3",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_SALES_INCO",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
          ...
          "isSearchParam": null,
          "lookupType": "VL",
          "lookupId": "93e5e6ecef9b4541b818878cfebb2afd",
          "businessType": "C",
          "isDefaulted": false,
          "defaultValue": null,
          "defaultValueText": null,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_SALES_INCO",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "585e5f606ddd48aba7d6e937f0972453",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "78bde712-0df7-4663-836c-432684e0b38d",
        "columnName": "ITM_CTC_SALES_INCO_LOC",
        "label": "Sales Incoterms Location",
        "description": "Sales Incoterms Location",
        "maxLength": "15",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_SALES_INCO_LOC",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_SALES_INCO_LOC",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "64200f97dac648b5835e303a655ea08a",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "1fe3fed9-aac2-4d2d-be64-db2600654b2a",
        "columnName": "ITM_CTC_TAX_CODE",
        "label": "Tax Code",
        ...
        "propertyDto": {
          ...
          "isSearchParam": null,
          "lookupType": "VL",
          "lookupId": "5f24cdccfacd4fd7af91ab0ba9bba4ab",
          "businessType": "C",
          "isDefaulted": false,
          "defaultValue": null,
          "defaultValueText": null,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_TAX_CODE",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "c218a7a2db9f477485d4084ff5a54447",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "61643198-7e5d-4863-a944-f9dd2a43ffc5",
        "columnName": "ITM_CTC_TERMS_OF_PAY",
        "label": "Terms of Payment(Buy)",
        "description": "Terms of Payment(Buy)",
        "maxLength": "10",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_TERMS_OF_PAY",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_TERMS_OF_PAY",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "225ab313e0d54ae385ec7d723bbff0e5",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "04db29cf-cd4a-424f-aa07-fa18679aa3e3",
        "columnName": "ITM_CTC_TERMS_OF_PAY_SELL",
        "label": "Terms of Payment(Sell)",
        "description": "Terms of Payment(Sell)",
        "maxLength": "10",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_CTC_TERMS_OF_PAY_SELL",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": true,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_TERMS_OF_PAY_SELL",
        "lookupRepresentation": null
      }
    ]
  }
...
// ─── Main Component ──────────────────────────────────────────────────────────────
const CreateB2BTradingContract3 = forwardRef(({ variantData: externalVariantData, initialData, requestOptions, onSubmit, onReset, columns = 2, title, showHeader = true, showFooter = true, readOnly = false, view = 'both' }, ref) => {
...
CreateB2BTradingContract3.displayName = 'CreateB2BTradingContract3';
export default CreateB2BTradingContract3;
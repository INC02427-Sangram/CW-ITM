/**
 * CTCB2BCurrencyPricing — Generated Form Component
 *
...
const EMBEDDED_VARIANT_DATA = [
  {
    ...
    "variantName": "CTC B2B CurrencyPricing",
    "definitionId": "IWM",
    "data": [
      {
      ...
      {
        "variantFieldId": "f54cb6fdb9e243e38416508822c72b9e",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
      ...
      {
        "variantFieldId": "6c04779c47f241db9963b0e6f34655ac",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        ...
        "description": "Sales Payment Terms",
        "maxLength": "10",
        "dataType": "NVARCHAR",
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
...
// ─── Main Component ──────────────────────────────────────────────────────────────
const CTCB2BCurrencyPricing = forwardRef(({ variantData: externalVariantData, initialData, requestOptions, dateFormat, onSubmit, onReset, columns = 2, title, showHeader = true, showFooter = true, readOnly = false }, ref) => {
...
CTCB2BCurrencyPricing.displayName = 'CTCB2BCurrencyPricing';
export default CTCB2BCurrencyPricing;
/**
 * CTCB2BExchangeRate — Generated Form Component
 *
...
const EMBEDDED_VARIANT_DATA = [
  {
    ...
    "variantName": "CTC B2B ExchangeRate",
    "definitionId": "IWM",
    "data": [
      {
...
// ─── Main Component ──────────────────────────────────────────────────────────────
const CTCB2BExchangeRate = forwardRef(({ variantData: externalVariantData, initialData, requestOptions, dateFormat, onSubmit, onReset, columns = 2, title, showHeader = true, showFooter = true, readOnly = false }, ref) => {
...
CTCB2BExchangeRate.displayName = 'CTCB2BExchangeRate';
export default CTCB2BExchangeRate;
/**
 * B2BTradingItemsFilter — Generated Form Component
 *
...
const EMBEDDED_VARIANT_DATA = [
  {
    "variantId": "2439b5828af44aafba8baf0368788df5",
    "variantName": "B2B Trading Items Filter",
    "definitionId": "IWM",
    "data": [
      {
        "variantFieldId": "76ae5a8989fa45f383b679d19ff8f5ff",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
      ...
      {
        "variantFieldId": "c2fedbc3722941808e9e1a4de93b8dc6",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
      ...
      {
        "variantFieldId": "388992fea3fc4324a61b80c6a537f9ac",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "a875f599-e8d1-4279-9c88-875e438a11ad",
        "columnName": "ITM_MATERIAL",
        "label": "Material",
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_MATERIAL",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "7d0d70b2d0024ba3b4b6c34131c289a1",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "2f79c0c6-84ea-4853-a279-3597af4b9de5",
        "columnName": "ITM_CTC_DEL_PERIOD_FROM",
        "label": "Delivery Period From",
        "description": "Delivery Period From",
        "maxLength": "15",
        "dataType": "DATE",
        "technicalDataType": "DATE",
        "controlName": "Date",
        "fieldName": "ITM_CTC_DEL_PERIOD_FROM",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": false,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_DEL_PERIOD_FROM",
        "lookupRepresentation": null
      },
      {
        "variantFieldId": "a579e6f01bba4fb68023848608104d93",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "d560e648-ebde-455d-a22d-fddbf2cc6586",
        "columnName": "ITM_CTC_DEL_PERIOD_TO",
        ...
        "technicalDataType": "DATE",
        "controlName": "Date",
        "fieldName": "ITM_CTC_DEL_PERIOD_TO",
        "propertyDto": {
          "isMultiSelect": null,
          "isEditable": true,
          "isMandatory": false,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_CTC_DEL_PERIOD_TO",
        "lookupRepresentation": null
      }
    ]
  }
...
// ─── Main Component ──────────────────────────────────────────────────────────────
const B2BTradingItemsFilter = forwardRef(({ variantData: externalVariantData, initialData, requestOptions, dateFormat, onSubmit, onReset, columns = 2, title, showHeader = true, showFooter = true, readOnly = false }, ref) => {
...
B2BTradingItemsFilter.displayName = 'B2BTradingItemsFilter';
export default B2BTradingItemsFilter;
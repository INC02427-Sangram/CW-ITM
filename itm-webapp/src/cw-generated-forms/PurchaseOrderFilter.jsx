/**
 * PurchaseOrderFilter — Generated Form Component
 *
...
const EMBEDDED_VARIANT_DATA = [
  {
    "variantId": "f0bd3012f44b43aeaa84276d030c6c37",
    "variantName": "Purchase Order Filter",
    "definitionId": "IWM",
    "data": [
      {
        "variantFieldId": "fe232bbaca544cf991dcef6763b35e9d",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
      ...
      {
        "variantFieldId": "134083045bee409aa96bc2ba6c51ebe4",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
      ...
      {
        "variantFieldId": "5c8207b17e6b4aff9fc2187defce65c2",
        "tableId": null,
        "schemaId": null,
        "isKey": null,
        "columnId": "88a42a76-5a84-458d-978f-49a2f0231c77",
        "columnName": "ITM_PURCHASE_ORDER_STATUS",
        ...
        "technicalDataType": "NVARCHAR",
        "controlName": "Input",
        "fieldName": "ITM_PURCHASE_ORDER_STATUS",
        "propertyDto": {
          "isMultiSelect": true,
          "isEditable": true,
          "isMandatory": false,
        ...
        "odataFieldDescription": null,
        "maxSequenceValue": null,
        "aliasName": "ITM_PURCHASE_ORDER_STATUS",
        "lookupRepresentation": null
      }
    ]
  }
...
// ─── Main Component ──────────────────────────────────────────────────────────────
const PurchaseOrderFilter = forwardRef(({ variantData: externalVariantData, initialData, requestOptions, dateFormat, onSubmit, onReset, columns = 2, title, showHeader = true, showFooter = true, readOnly = false }, ref) => {

 ...
 * Defines sidebar navigation with routing components for MainContainer
 * Nested routes (like create-contract) are handled within their parent components
 */
